class Game {
  ...
  play() {
    ...
    if(player.index===1){
      fill("red");
        text("Press 'F' to  attack the mouse, "+player.name,displayWidth / 2-100,50);
    }
    else{
      fill("red");
      text("Press 'D' to  attack the cat, "+player.name,displayWidth / 2 - 100,50);
    }
    ...
    if(val===1){
      ...
      image(catwin,displayWidth/2-100,displayHeight/2-200,400,400);
      fill("blue");
      textSize(20)
      text("You have defeated your arch rival, you champ!!",displayWidth/2-100,150);
      text("Congratulations, "+name+"!",displayWidth/2,175);
    }
    else{
      image(milk,0,0,displayWidth-20,displayHeight-170)
      image(catwin,displayWidth/2-100,displayHeight/2-200,400,400);
      fill("blue");
      textSize(20)
      text("You lost, but you played so well!!",displayWidth/2-100,150);
      text("Better Luck next time, "+loserName+"!",displayWidth/2,175);
    }
    }
    else{
      clear();
